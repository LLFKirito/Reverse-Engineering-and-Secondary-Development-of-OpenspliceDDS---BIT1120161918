...
//  Source: C:/cygwin/home/dds/OvernightTests/tmp_DAdBDMJVQJ/build/etc/idl/dds_builtinTopics.idl
...
namespace DDS
{
   ...
   OS_API extern BuiltinTopicKey_t_slice * BuiltinTopicKey_t_alloc ();
   OS_API extern void BuiltinTopicKey_t_free (BuiltinTopicKey_t_slice *);
   OS_API extern void BuiltinTopicKey_t_copy (BuiltinTopicKey_t_slice* to, const BuiltinTopicKey_t_slice* from);
   OS_API extern BuiltinTopicKey_t_slice *BuiltinTopicKey_t_dup (const BuiltinTopicKey_t_slice* from);
   ...
   struct OS_API UserDataQosPolicy
   {
         octSeq value;
   };
   ...
   struct OS_API TopicDataQosPolicy
   {
         octSeq value;
   };
   ...
   struct OS_API GroupDataQosPolicy
   {
         octSeq value;
   };
   ...
   struct OS_API TransportPriorityQosPolicy
   {
         Long value;
   };
   ...
   struct OS_API LifespanQosPolicy
   {
         Duration_t duration;
   };
   ...
   struct OS_API DurabilityQosPolicy
   {
   ...
   struct OS_API PresentationQosPolicy
   {
   ...
   struct OS_API DeadlineQosPolicy
   {
         Duration_t period;
   };
   ...
   struct OS_API LatencyBudgetQosPolicy
   {
         Duration_t duration;
   };
   ...
   struct OS_API OwnershipQosPolicy
   {
   ...
   struct OS_API OwnershipStrengthQosPolicy
   {
         Long value;
   };
   ...
   struct OS_API LivelinessQosPolicy
   {
   ...
   struct OS_API TimeBasedFilterQosPolicy
   {
   ...
   struct OS_API PartitionQosPolicy
   {
         StringSeq name;
   };
   ...
   struct OS_API ReliabilityQosPolicy
   {
   ...
   struct OS_API DestinationOrderQosPolicy
   {
   ...
   struct OS_API HistoryQosPolicy
   {
   ...
   struct OS_API ResourceLimitsQosPolicy
   {
         Long max_samples;
         Long max_instances;
   ...
   struct OS_API DurabilityServiceQosPolicy
   {
   ...
   struct OS_API ProductDataQosPolicy
   {
         String_mgr value;
   };
   ...
   struct OS_API EntityFactoryQosPolicy
   {
   ...
   struct OS_API WriterDataLifecycleQosPolicy
   {
   ...
   struct OS_API InvalidSampleVisibilityQosPolicy
   {
   ...
   struct OS_API SubscriptionKeyQosPolicy
   {
   ...
   struct OS_API ReaderDataLifecycleQosPolicy
   {
   ...
   struct OS_API UserKeyQosPolicy
   {
         Boolean enable;
   ...
   struct OS_API ReaderLifespanQosPolicy
   {
   ...
   struct OS_API ParticipantBuiltinTopicData
   {
   ...
   struct OS_API TopicBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         String_mgr name;
   ...
   struct OS_API TypeBuiltinTopicData
   {
         String_mgr name;
   ...
   struct OS_API PublicationBuiltinTopicData
   {
         BuiltinTopicKey_t key;
   ...
   struct OS_API SubscriptionBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         BuiltinTopicKey_t participant_key;
         String_mgr topic_name;
   ...
   struct OS_API CMParticipantBuiltinTopicData
   {
         BuiltinTopicKey_t key;
   ...
   struct OS_API CMPublisherBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         ProductDataQosPolicy product;
         BuiltinTopicKey_t participant_key;
   ...
   struct OS_API CMSubscriberBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         ProductDataQosPolicy product;
         BuiltinTopicKey_t participant_key;
   ...
   struct OS_API CMDataWriterBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         ProductDataQosPolicy product;
   ...
   struct OS_API CMDataReaderBuiltinTopicData
   {
         BuiltinTopicKey_t key;
         ProductDataQosPolicy product;
