 ...
 */
 ...
 /*****************************************************************************
  * LOGICAL_NAME:    HashDepartment.cpp
  * DATE:            November 2018.
  *****************************************************************************/
...
int DigestDepartment(int argc, char *argv[])
{
	...
	cout << "Digest department ready." << endl;
	...
	cout << "Digest department shutdown." << endl;
...
{
	return DigestDepartment(argc, argv);
}
