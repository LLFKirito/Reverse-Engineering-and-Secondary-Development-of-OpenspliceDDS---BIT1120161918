 ...
 */
 ...
 /*****************************************************************************
  * LOGICAL_NAME:    SignDepartment.cpp
  * DATE:            November 2018.
  *****************************************************************************/
...
int SignatureDepartment(int argc, char *argv[])
{
	...
	cout << "Signature department ready." << endl;
	...
	cout << "Signature department shutdown." << endl;
...
{
	return SignatureDepartment(argc, argv);
}
