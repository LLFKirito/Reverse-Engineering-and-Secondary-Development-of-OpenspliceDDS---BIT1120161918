...
extern SAC_BUILTIN v_copyin_result __DDS_Duration_t__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_Duration_t__copyOut(const void *_from, void *_to);
struct _DDS_Duration_t {
    c_long sec;
    c_ulong nanosec;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_UserDataQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_UserDataQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_UserDataQosPolicy {
    _DDS_octSeq value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_TopicDataQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TopicDataQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_TopicDataQosPolicy {
    _DDS_octSeq value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_GroupDataQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_GroupDataQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_GroupDataQosPolicy {
    _DDS_octSeq value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_TransportPriorityQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TransportPriorityQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_TransportPriorityQosPolicy {
    c_long value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_LifespanQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_LifespanQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_LifespanQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_DurabilityQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_DurabilityQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_DurabilityQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_PresentationQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_PresentationQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_PresentationQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_DeadlineQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_DeadlineQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_DeadlineQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_LatencyBudgetQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_LatencyBudgetQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_LatencyBudgetQosPolicy {
    struct _DDS_Duration_t duration;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_OwnershipQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_OwnershipQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_OwnershipQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_OwnershipStrengthQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_OwnershipStrengthQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_OwnershipStrengthQosPolicy {
    c_long value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_LivelinessQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_LivelinessQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_LivelinessQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_TimeBasedFilterQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TimeBasedFilterQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_TimeBasedFilterQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_PartitionQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_PartitionQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_PartitionQosPolicy {
    _DDS_StringSeq name;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_ReliabilityQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ReliabilityQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ReliabilityQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_DestinationOrderQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_DestinationOrderQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_DestinationOrderQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_HistoryQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_HistoryQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_HistoryQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_ResourceLimitsQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ResourceLimitsQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ResourceLimitsQosPolicy {
    c_long max_samples;
...
extern SAC_BUILTIN v_copyin_result __DDS_DurabilityServiceQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_DurabilityServiceQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_DurabilityServiceQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_ProductDataQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ProductDataQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ProductDataQosPolicy {
    c_string value;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_EntityFactoryQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_EntityFactoryQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_EntityFactoryQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_ShareQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ShareQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ShareQosPolicy {
    c_string name;
    c_bool enable;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_WriterDataLifecycleQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_WriterDataLifecycleQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_WriterDataLifecycleQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_InvalidSampleVisibilityQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_InvalidSampleVisibilityQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_InvalidSampleVisibilityQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_SubscriptionKeyQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_SubscriptionKeyQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_SubscriptionKeyQosPolicy {
    c_bool use_key_list;
...
extern SAC_BUILTIN v_copyin_result __DDS_ReaderDataLifecycleQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ReaderDataLifecycleQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ReaderDataLifecycleQosPolicy {
...
extern SAC_BUILTIN v_copyin_result __DDS_UserKeyQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_UserKeyQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_UserKeyQosPolicy {
    c_bool enable;
    c_string expression;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_ReaderLifespanQosPolicy__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ReaderLifespanQosPolicy__copyOut(const void *_from, void *_to);
struct _DDS_ReaderLifespanQosPolicy {
    c_bool use_lifespan;
    struct _DDS_Duration_t duration;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_TypeHash__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TypeHash__copyOut(const void *_from, void *_to);
struct _DDS_TypeHash {
    c_ulonglong msb;
    c_ulonglong lsb;
};
...
extern SAC_BUILTIN v_copyin_result __DDS_ParticipantBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_ParticipantBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_ParticipantBuiltinTopicData {
...
extern SAC_BUILTIN v_copyin_result __DDS_TopicBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TopicBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_TopicBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    c_string name;
    c_string type_name;
...
extern SAC_BUILTIN v_copyin_result __DDS_TypeBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_TypeBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_TypeBuiltinTopicData {
    c_string name;
...
extern SAC_BUILTIN v_copyin_result __DDS_PublicationBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_PublicationBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_PublicationBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
...
extern SAC_BUILTIN v_copyin_result __DDS_SubscriptionBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_SubscriptionBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_SubscriptionBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    _DDS_BuiltinTopicKey_t participant_key;
    c_string topic_name;
...
extern SAC_BUILTIN v_copyin_result __DDS_CMParticipantBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_CMParticipantBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_CMParticipantBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
...
extern SAC_BUILTIN v_copyin_result __DDS_CMPublisherBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_CMPublisherBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_CMPublisherBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    struct _DDS_ProductDataQosPolicy product;
    _DDS_BuiltinTopicKey_t participant_key;
...
extern SAC_BUILTIN v_copyin_result __DDS_CMSubscriberBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_CMSubscriberBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_CMSubscriberBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    struct _DDS_ProductDataQosPolicy product;
    _DDS_BuiltinTopicKey_t participant_key;
...
extern SAC_BUILTIN v_copyin_result __DDS_CMDataWriterBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_CMDataWriterBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_CMDataWriterBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    struct _DDS_ProductDataQosPolicy product;
...
extern SAC_BUILTIN v_copyin_result __DDS_CMDataReaderBuiltinTopicData__copyIn(c_base base, const void *from, void *to);
extern SAC_BUILTIN void __DDS_CMDataReaderBuiltinTopicData__copyOut(const void *_from, void *_to);
struct _DDS_CMDataReaderBuiltinTopicData {
    _DDS_BuiltinTopicKey_t key;
    struct _DDS_ProductDataQosPolicy product;
